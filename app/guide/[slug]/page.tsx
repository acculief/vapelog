...
const SLUG_SEARCH_QUERIES: Record<string, string> = {
  ...
  'vape-cost-comparison': 'VAPE スターターキット',
  'vape-starter-checklist': 'スターターキット',
  'vape-battery-safety': 'VAPEバッテリー',
}
...
const FAQ_DATA: Record<string, { q: string; a: string }[]> = {
  ...
  'vape-rules-japan': [
    ...
    { q: 'VAPEに切り替えると年間どのくらい節約できますか？', a: '1日1箱（約19,000円/月）喫煙者の場合、VAPEのランニングコストは月4,500〜7,000円程度のため、初年度から年間約16〜17万円の節約が見込めます。2年目以降はデバイス費用も不要なためさらに節約になります。' },
    { q: 'VAPEのリキッド代は月いくらかかりますか？', a: '使用頻度によりますが、月2,000〜4,000円が目安です。まとめ買い（ラージボトル）で1mlあたりの単価を下げることができます。' },
    { q: 'VAPEのコイルはどのくらいのコストがかかりますか？', a: '1個300〜800円程度で、月に2〜4個の交換が目安です。月600〜3,200円が相場です。コイル寿命を延ばすプライミングや適切な使い方でコストを抑えられます。' },
  ],
  'vape-starter-checklist': [
    { q: 'VAPEを始めるために最低限必要なものは何ですか？', a: 'デバイス本体（ポッド型推奨）・リキッド・充電ケーブル・替えコイルの4点が最低限必要です。これだけ揃えればVAPEライフをスタートできます。' },
    { q: '初心者向けVAPEデバイスの予算はどのくらいですか？', a: 'ポッド型スターターキットは3,000〜8,000円が相場です。まず試してみたい方は使い捨てVAPE（1,000〜2,000円）から始めるのも選択肢の一つです。' },
    { q: 'VAPEのリキッドはどれを選べばいいですか？', a: '初心者にはフルーツ系（マンゴー・ストロベリーなど）かメンソール系がおすすめです。PG50/VG50のバランス型リキッドを選ぶと、蒸気量とフレーバーのバランスが良く使いやすいです。' },
  ],
  'vape-battery-safety': [
    { q: 'VAPEのバッテリーは充電しながら使っても大丈夫ですか？', a: '基本的には避けることをおすすめします。充電中の使用はバッテリーへの負荷が高まり、発熱・劣化が早まる原因になります。充電が完了してから使用するのが理想です。' },
    { q: 'VAPEバッテリーが膨張したらどうすればいいですか？', a: '膨張したバッテリーは即時使用中止が必要です。破裂・発火のリスクがあります。購入店や自治体の廃棄場所に持ち込み、適切に処分してください。' },
    { q: 'VAPEを長期間使わないときのバッテリー保管方法は？', a: '残量30〜80%の状態で、直射日光が当たらない常温（15〜25℃）の場所で保管してください。満充電または空の状態での長期保管はバッテリー劣化を早めます。' },
  ],
}
